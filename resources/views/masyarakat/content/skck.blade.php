...
<div class="max-w-4xl mx-auto">
    <h1 class="surat">Surat Pengantar SKCK </h1>
    <form action="" class="form-container">
        ...
        <div class="mb-5">
          <label for="kewarganegaraan" class="block mb-2 text-sm font-medium text-white">Kewarganegaraan</label>
          <select id="kewarganegaraan" class="input-style select-style">

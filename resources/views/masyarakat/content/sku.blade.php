...
<div class="max-w-4xl mx-auto">
    ...
    <form action="" class="form-container">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="nama_usaha" class="input-style" required />
        </div>
  
        <div class="mb-5">
            <label for="tahun_usaha" class="block mb-2 text-sm font-medium text-white">Tahun Mulai Usaha</label>
            <input type="text" id="tahun_usaha" class="input-style" required pattern="^(19|20)\d{2}$" title="Masukkan tahun antara 1900 hingga 2099" />
        </div>
  
        <div class="mb-5">
            <label for="alamat_usaha" class="block mb-2 text-sm font-medium text-white">Alamat Usaha</label>
            <input type="text" id="alamat_usaha" class="input-style" required />
        </div>
  
        <div class="mb-5">
            <label for="ukuran_tempat_usaha" class="block mb-2 text-sm font-medium text-white">Ukuran Tempat Usaha</label>
            <input type="text" id="ukuran_tempat_usaha" class="input-style" required />
        </div>
